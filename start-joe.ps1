...
# --- متصفح جو يرث حسابك من متصفحك الحقيقي ---
# جو يفتح متصفحك الحقيقي (Chrome/Edge/Brave/Opera) بملفك الشخصي، فيكون مسجّلاً
# بنفس حسابك تلقائياً بلا أي تسجيل دخول — كل شيء داخل لوحة جو (بلا نافذة خارجية).
# شرط واحد فقط: أغلق نوافذ متصفحك قبل تشغيل جو (المتصفح يمنع فتح نفس الملف مرّتين).
$env:USE_USER_BROWSER_PROFILE = "1"  # يرث حسابك من متصفحك الحقيقي المثبّت
$env:USE_SYSTEM_CHROME = "1"         # استخدم Chrome الحقيقي (وليس Chromium المرفق)
