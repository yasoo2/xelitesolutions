...
# يشغّل جو متصفح Chrome حقيقياً بملف تعريف دائم داخل لوحة جو المدمجة (بلا نافذة
# خارجية). تسجّل دخولك لحساباتك مرة واحدة من داخل اللوحة (انقر واكتب فيها مباشرة)
# فتبقى محفوظة للأبد بحسابك الخاص. يطلب جو موافقتك مرّة واحدة قبل الاستخدام.
# لإيقاف الميزة والعودة للمتصفح المعزول: احذف USE_SYSTEM_CHROME أو اجعله "0".
