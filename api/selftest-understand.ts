...
async function main() {
  ...
  check('deriveStartUrl navigates straight to the named site login', deriveStartUrl('ادخل على جيت هاب وسجل الدخول') === 'https://github.com/login', deriveStartUrl('ادخل على جيت هاب وسجل الدخول'));
