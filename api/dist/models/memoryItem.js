...
const MemoryItemSchema = new mongoose_1.Schema({
    scope: { type: String, enum: ['session', 'project', 'user'], required: true },
    sessionId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Session', index: true },
...
exports.MemoryItem = mongoose_1.default.model('MemoryItem', MemoryItemSchema);
