        ...
        const prompt = (new ProjectPlannerTool() as any).createCompactRecoveryPlanningPrompt(
            ...
            [],
            {
                ...
                selectedProject: {
                    ...
                    candidateChecks: [{ kind: 'typecheck', command: 'node --check src/server.js', source: '/tmp/joe-workspace/package.json' }],
                },
                referenceProjects: [],
            },
        );
        ...
        const result: any = await new ProjectPlannerTool().execute({
            ...
            evidence: {
                ...
                constraints: {
                    localOnly: true,
                    forbidDeploy: true,
                    userRequestedExistingProject: true,
        ...
        const result: any = await new ProjectPlannerTool().execute({
            ...
            evidence: {
                ...
                constraints: {
                    localOnly: true,
                    forbidDeploy: true,
                    userRequestedExistingProject: false,
