...
const DETERMINISTIC_TOOLS = [
    ...
    'web_page_builder', 'react_project', 'api_project', 'orders_read', 'project_edit', 'form_inbox', 'import_project', 'github_repo_manager', 'project_pipeline', 'project_run', 'project_stop', 'deploy_pages',
];
