...
export class DeployManager {
    ...
    private async runDeployProcess(id: string, isRollback = false, expectedCommit?: string) {
        ...
        try {
            ...
            this.runCommand('/bin/sh', ['-c', '"docker rm -f joe_api joe_web joe_mongo joe_browser_worker joe_nginx joe-certbot-1 || true && docker compose -p joe -f docker-compose.production.yml up -d --build"'], id, 1200000).catch(e => {
