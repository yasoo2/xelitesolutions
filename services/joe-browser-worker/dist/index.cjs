...
async function launchChromium() {
  ...
  try {
    return await import_playwright.chromium.launch({ args, headless, channel: "chrome" });
  } catch {
  }
  return await import_playwright.chromium.launch({ args, headless });
}
